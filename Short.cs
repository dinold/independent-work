...
namespace ConsoleApp1
{
    ...
    { 
        ...
        public static string Shortening( this double value, string[] massiveRaz, int afterComma, string Language) // Метод, сокращающий запись числа и определяющий его разряд в диапазоне от до 10^3 до 10^17
        {
            int Razmer = massiveRaz.Length;
            if (Razmer < 5)
            {
